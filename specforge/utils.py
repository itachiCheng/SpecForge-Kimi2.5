    ...
    with open(file_path, "r", encoding="utf-8") as f:
        for i, line in enumerate(f):
            ...
            try:
                ...
                # Preserve non-conversation fields (e.g., id, image) for VLM datasets.
                # We skip "conversations" itself and handle "tools" separately below.
                for key, value in row.items():
                    if key in {"conversations", "tools"}:
                        continue
